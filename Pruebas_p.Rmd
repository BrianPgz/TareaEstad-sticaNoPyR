...
```
```{r echo=TRUE}
setwd("C:/Users/Brian Pérez/Documents/Estadística 2/GitEstadística/TareaEstad-sticaNoPyR")
```
...
```{r echo=TRUE}
Datos_R1<-read.csv('pregunta1.csv')
n_R1<-1000
...
```{r echo=TRUE}
DAtosK_R2<-read.csv('pregunta2.csv')
alpha_R2=0.5
...
Data_In<-read.csv('pregunta3.csv')
alpha_R3=0.05
...
```{r echo=TRUE}
Data_In<-read.csv('pregunta5.csv')
alpha=0.05

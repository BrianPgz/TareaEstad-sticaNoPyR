...
Un psicologo esta investigando el impacto que el divorcio de los padres tiene
sobre el aprovechamiento academico de los niC1os. El psicologo cuenta con las
calicaciones de un grupo de ni~nos de escuela primaria cuyos padres tuvieron
un divorcio durante el aC1o terior, y las calicaciones para un grupo de niC1os
similares cuyos padres no se divorciaron.


## Pruebas de correlaciC3n de rango 
## Problema 3
La tabla que se proporciona a continuaci??n da el n??mero de premios de postgraduados en ciencia m??dica y la raz??n de muerte por mill??n de tuberculosis para los a??os 1959-69.

Demuestre que estos datos muestran una fuerte evidencia de correlaci??n negativa
entre el n??mero de premios y la tasa de muerte por tuberculosis. Explique este
"extra??o" resultado. Use = 0.05. 

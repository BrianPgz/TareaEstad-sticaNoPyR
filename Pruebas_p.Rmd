...
```{r echo=TRUE}
datos_div$rango=rank(Data$Promedio)
print(datos_div)
...
```{r echo=TRUE}
suma_rango<-datos_div %>%
group_by(Estado) %>% summarise(suma_rango = sum(rango))
...
## Pruebas de correlaciC3n de rango 
## Problema 3
La tabla que se proporciona a continuación da el número de premios de postgraduados en ciencia médica y la razón de muerte por millón de tuberculosis para los años 1959-69.

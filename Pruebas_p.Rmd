...
```
Entonces rechazamos $H_{0}$, no hay evidencia suficiente para que tengan una correlacion negativa. 
...
```
Como el $p-value<\alpha$, entonces se rechaza $H_{o}$, entonces la correlación no es negativa.

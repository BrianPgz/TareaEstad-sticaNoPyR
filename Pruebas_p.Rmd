...
print(paises)
```
Planteamos la prueba de hipótesis (prueba de una cola) Ho: Existe una tendencia para que los valores más grandes de X estén emparejados" con los valores más grandes de Y y los valores más chicos de X estén emparejados" con los valores más chicos de Y.   
